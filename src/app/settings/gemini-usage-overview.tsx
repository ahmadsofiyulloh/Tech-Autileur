...
function GeminiUsageDonut({ entries }: { entries: MetricEntry[] }) {
  ...
  return (
    <ChartContainer config={quotaChartConfig} className="gemini-usage-donut">
      <PieChart>
        <Pie
          data={chartData}
          dataKey="value"
...
export function GeminiUsageOverviewPanel({ overview }: GeminiUsageOverviewPanelProps) {
  ...
  return (
    <section className="gemini-usage-overview" aria-label="Penggunaan Gemini">
