...
export const routeTitles = [
  ...
  { href: "/settings/about", label: "Tentang", subtitle: "Versi dan dukungan.", icon: Info },
  ...
  { href: "/share/facebook", label: "Share", subtitle: "Caption Facebook.", icon: Send },
  { href: "/share/threads", label: "Share", subtitle: "Caption Threads.", icon: Send },
  { href: "/share/x", label: "Share", subtitle: "Caption X.", icon: Send },
  { href: "/share/pinterest", label: "Share", subtitle: "Caption Pinterest.", icon: Send },
  { href: "/share", label: "Share", subtitle: "Pilih platform.", icon: Send },
